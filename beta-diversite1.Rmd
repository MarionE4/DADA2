...
Utilisation du package NbClust pour déterminer le nombres exacts de clusters dans le jeu de données.
```{r, eval=FALSE}
install.packages("NbClust", lib = ".")
library("NbClust", lib.loc = ".")
```
```{r}
install.packages("NbClust", lib = ".", repos = "https://cloud.r-project.org/")
